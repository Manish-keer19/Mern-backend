...
require("dotenv");
require('dotenv').config(); // Call config() to load environment variables
...
const dbConnect = () => {
	...
	mongoose.connect(process.env.DATABASE_URL, {
		// .connect('mongodb+srv://manishkeer530:manishkeer19@manish.dz6nzsm.mongodb.net/manishdb', {
		// .connect('mongodb+srv://manishkeer530:manishkeer19@manish.dz6nzsm.mongodb.net/manishdb?retryWrites=true&w=majority', {
